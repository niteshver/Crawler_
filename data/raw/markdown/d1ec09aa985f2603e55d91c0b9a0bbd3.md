...
Pricing for Opus 4.8 starts at $5 per million input tokens and $25 per million output tokens, with up to 90% cost savings with `claude-opus-4-8` via the 
...
Pricing depends on how you want to use Opus 4.8. To learn more, check out our 

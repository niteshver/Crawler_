...
### 3. Variational Autoencoders (VAEs) and Generative Adversarial Networks (GANs)
  * and were among the first deep learning architectures for generative tasks.
...
## Applications of Generative AI
  * : Powers chatbots, virtual assistants, content creation, document summarization and even code generation tools like GitHub Copilot.
  * : Used in digital art, product design, fashion, advertising and medical imaging to create visuals that are close to real-world examples.
  ...
  * : Supports animation, movie special effects, gaming, marketing videos and realistic training simulations.

...
****Artificial intelligence (AI)**** is the branch of ****computer science**** that aims to create intelligent agents, which are systems that can  and ****act autonomously****. This involves developing algorithms and techniques that enable machines to perform tasks that typically require human intelligence such as understanding and responding to ****natural language********recognizing objects in images********making autonomous decisions**** and ****solving complex problems****.
